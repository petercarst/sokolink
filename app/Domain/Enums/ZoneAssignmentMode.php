...
/**
 * Whether an admin assigns tasks in this zone, or agents claim them.
 *
 * Mirrors `delivery_zones`.`assignment_mode`. The two are asserted equal by
 ...
 */
enum ZoneAssignmentMode: string
{
    case Admin = 'admin';
    case Pool = 'pool';
